...
public class AvgReducerServiceTest {
	...
	void testNoAvgValue() {
		...
		System.out.println("probesList: " + probesList);
		assertNotNull(probesList);
	...
	void testAvgValue() {
		...
		assertEquals(1, VALUES_AVG.size());
		...
		System.out.println("VALUES_AVG: " + VALUES_AVG);
		
		assertEquals(probesList.getValues(), VALUES_AVG);
	}
}